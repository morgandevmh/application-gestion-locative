...
-- DropForeignKey
ALTER TABLE "Bien" DROP CONSTRAINT "Bien_userId_fkey";
...
-- AlterTable
ALTER TABLE "BailTemplate" ALTER COLUMN "userId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "Bien" ALTER COLUMN "userId" SET DATA TYPE TEXT;
